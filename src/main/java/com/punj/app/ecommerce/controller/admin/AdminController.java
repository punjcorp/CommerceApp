...
public class AdminController {
	...
	public String login(Model model) {
		...
		LocalDateTime businessDate = LocalDateTime.of(localDate.getYear(), localDate.getMonth(), 8, 0, 0);

		DashboardDTO dashboardDTO = this.reportingService.retrieveTotalsByDate(new Integer("7997"), businessDate);
