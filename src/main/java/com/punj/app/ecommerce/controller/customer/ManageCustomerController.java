...
public class ManageCustomerController {
	...
	public String saveCustomer(@ModelAttribute("customerBean") @Valid CustomerBean customerBean, BindingResult bindingResult, Model model, HttpSession session, Locale locale,
	...
	public String saveCustomerAfterEdit(@ModelAttribute("customerBean") @Valid CustomerBean customerBean, BindingResult bindingResult, Model model, HttpSession session,
