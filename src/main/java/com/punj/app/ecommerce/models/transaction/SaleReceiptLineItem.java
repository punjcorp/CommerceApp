...
public class SaleReceiptLineItem {
	...
	/**
	 * @param grossQty the grossQty to set
	 */
	...
	/**
	 * @param sgstTaxRate the sgstTaxRate to set
	 */
	...
	/**
	 * @param sgstTaxAmount the sgstTaxAmount to set
	 */
	...
	/**
	 * @param cgstTaxRate the cgstTaxRate to set
	 */
	...
	/**
	 * @param cgstTaxAmount the cgstTaxAmount to set
	 */
	...
	/**
	 * @param igstTaxRate the igstTaxRate to set
	 */
	...
	/**
	 * @param igstTaxAmount the igstTaxAmount to set
	 */
