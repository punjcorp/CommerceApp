...
public class LocSKUDetails implements Serializable {
	...
	private static final long serialVersionUID = -1999050177321699254L;
	...
	/**
	 * @param nonSellableQty the nonSellableQty to set
	 */
	...
	/**
	 * @param taxGroupName the taxGroupName to set
	 */
	...
	/**
	 * @param sgstRateRuleId the sgstRateRuleId to set
	 */
	...
	/**
	 * @param cgstRateRuleId the cgstRateRuleId to set
	 */
	...
	/**
	 * @param igstRateRuleId the igstRateRuleId to set
	 */
	...
	/**
	 * @param priceChangeType the priceChangeType to set
	 */
