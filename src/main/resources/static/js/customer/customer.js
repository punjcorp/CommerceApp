...
function isShortCustomer(radioCntl){
	var gstCaptureFlagCntl=radioCntl.id;
	var gstCaptureFlag=$('#'+gstCaptureFlagCntl).val();
	
	if(gstCaptureFlag!=undefined && typeof(gstCaptureFlag)!=='undefined' && gstCaptureFlag=='F'){
		$('#phone2Container').removeClass('d-none');
		$('#gstRow').removeClass('d-none');
		$('#addressesContainer').removeClass('d-none');
		$('#btnSave').attr('name', 'saveCustomer');
		
	}else if(gstCaptureFlag!=undefined && typeof(gstCaptureFlag)!=='undefined' && gstCaptureFlag=='T'){
		$('#phone2Container').addClass('d-none');
		$('#gstRow').addClass('d-none');
		$('#addressesContainer').addClass('d-none');
		$('#btnSave').attr('name', 'saveShortCustomer');
	}
}