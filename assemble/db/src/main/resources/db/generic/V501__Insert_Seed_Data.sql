...
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Item Default Hierarchy','app.item.default.hierarchy','Default');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default Item Type','app.item.default.item.type','merchandise');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default UOM','app.item.default.uom','UNT');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default Item Pack Size','app.item.default.pack.size','1');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default Unit Cost','app.item.default.unit.cost','0.00');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default Max Retail Price','app.item.default.mrp','0.00');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default Suggested Price','app.item.default.suggested.price','0.00');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default Compare At Price','app.item.default.compareat.price','0.00');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default Restocking Price','app.item.default.restocking.fee','0.00');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Discount Applicable Flag','app.item.default.discount.flag','true');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Return Applicable Flag','app.item.default.return.flag','true');
...
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default List Screen Page Count','app.screen.default.page.count','5');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default Printer Name','app.default.printer.name','RICOH SP 210 DDST');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default Receipt Export Format','app.default.receipt.export.method','PDF');
INSERT INTO `commercedb`.`global_config` (`name`,`conf_key`,`conf_value`) VALUES ('Default Location','app.default.location','1234');
