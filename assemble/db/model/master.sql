...
-- Schema pi_pos_industry
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `pi_pos_industry` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `pi_pos_industry` ;
...
-- -----------------------------------------------------
-- Table `pi_pos_industry`.`purchase_order`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`purchase_order` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`purchase_order` (
...
CREATE INDEX `fk_purchase_order_supplier1_idx` ON `pi_pos_industry`.`purchase_order` (`supplier_id` ASC);


-- -----------------------------------------------------
-- Table `pi_pos_industry`.`purchase_order_items`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`purchase_order_items` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`purchase_order_items` (
...
CREATE INDEX `fk_purchase_order_items_purchase_order1_idx` ON `pi_pos_industry`.`purchase_order_items` (`order_id` ASC);

CREATE INDEX `fk_purchase_order_items_item1_idx` ON `pi_pos_industry`.`purchase_order_items` (`item_id` ASC);
...
-- -----------------------------------------------------
-- Table `pi_pos_industry`.`tax_group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`tax_group` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`tax_group` (
...
-- -----------------------------------------------------
-- Table `pi_pos_industry`.`tax_authority`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`tax_authority` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`tax_authority` (
...
-- -----------------------------------------------------
-- Table `pi_pos_industry`.`tax_location`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`tax_location` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`tax_location` (
...
CREATE UNIQUE INDEX `code_UNIQUE` ON `pi_pos_industry`.`tax_location` (`code` ASC);


-- -----------------------------------------------------
-- Table `pi_pos_industry`.`tax_group_rule`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`tax_group_rule` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`tax_group_rule` (
  `tax_group_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_tax_group_rule_tax_authority1`
    ...
    REFERENCES `pi_pos_industry`.`tax_authority` (`tax_authority_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tax_group_rule_tax_location1`
    FOREIGN KEY (`tax_location_id`)
    REFERENCES `pi_pos_industry`.`tax_location` (`tax_location_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tax_group_rule_tax_group1`
    FOREIGN KEY (`tax_group_id`)
    REFERENCES `pi_pos_industry`.`tax_group` (`tax_group_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_tax_group_rule_tax_location1_idx` ON `pi_pos_industry`.`tax_group_rule` (`tax_location_id` ASC);

CREATE INDEX `fk_tax_group_rule_tax_group1_idx` ON `pi_pos_industry`.`tax_group_rule` (`tax_group_id` ASC);


-- -----------------------------------------------------
-- Table `pi_pos_industry`.`tax_bracket`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`tax_bracket` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`tax_bracket` (
...
-- -----------------------------------------------------
-- Table `pi_pos_industry`.`tax_rate_rule`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`tax_rate_rule` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`tax_rate_rule` (
  `tax_group_id` INT NOT NULL,
  `tax_location_id` INT NOT NULL,
  `tax_authority_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_tax_rate_rule_tax_bracket1`
    ...
    REFERENCES `pi_pos_industry`.`tax_bracket` (`tax_bracket_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tax_rate_rule_tax_group_rule1`
    FOREIGN KEY (`tax_group_id` , `tax_location_id` , `tax_authority_id` , `tax_group_rule_seq`)
    REFERENCES `pi_pos_industry`.`tax_group_rule` (`tax_group_id` , `tax_location_id` , `tax_authority_id` , `seq_no`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_tax_rate_rule_tax_bracket1_idx` ON `pi_pos_industry`.`tax_rate_rule` (`tax_bracket_id` ASC);

CREATE INDEX `fk_tax_rate_rule_tax_group_rule1_idx` ON `pi_pos_industry`.`tax_rate_rule` (`tax_group_id` ASC, `tax_location_id` ASC, `tax_authority_id` ASC, `tax_group_rule_seq` ASC);


-- -----------------------------------------------------
-- Table `pi_pos_industry`.`tax_location_mapping`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`tax_location_mapping` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`tax_location_mapping` (
  `location_id` INT(4) NOT NULL,
  `tax_location_id` INT NOT NULL,
...
CREATE INDEX `fk_tax_location_mapping_tax_location1_idx` ON `pi_pos_industry`.`tax_location_mapping` (`tax_location_id` ASC);
...
CREATE INDEX `fk_txn_li_tax_txn_line_item_master_audit1_idx` ON `pi_pos_industry`.`txn_li_tax` (`location_id` ASC, `business_date` ASC, `register` ASC, `txn_no` ASC, `seq_no` ASC);
...
CREATE INDEX `fk_tender_id_no_sale_tender_fk1_idx` ON `pi_pos_industry`.`txn_no_sale_tender` (`tender_id` ASC);
...
-- -----------------------------------------------------
-- Table `pi_pos_industry`.`purchase_order_payment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`purchase_order_payment` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`purchase_order_payment` (
...
-- -----------------------------------------------------
-- Table `pi_pos_industry`.`purchase_order_items_tax`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`purchase_order_items_tax` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`purchase_order_items_tax` (
  ...
  CONSTRAINT `fk_purchase_order_items_tax_purchase_order_items1`
    ...
    REFERENCES `pi_pos_industry`.`purchase_order_items` (`order_item_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_purchase_order_items_tax_purchase_order_items1_idx` ON `pi_pos_industry`.`purchase_order_items_tax` (`order_item_id` ASC);


-- -----------------------------------------------------
-- Table `pi_pos_industry`.`purchase_order_bills`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pi_pos_industry`.`purchase_order_bills` ;

CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`purchase_order_bills` (
...
CREATE INDEX `fk_uom_master_uom_master1_idx` ON `pi_pos_industry`.`uom_master` (`parent_uom_id` ASC);
...
CREATE INDEX `fk_table1_address_master1_idx` ON `pi_pos_industry`.`customer_address` (`address_id` ASC);
...
CREATE INDEX `fk_purchase_order_return_purchase_order1_idx` ON `pi_pos_industry`.`po_return` (`order_id` ASC);
...
CREATE INDEX `fk_sale_txn_invoices_txn_master1_idx` ON `pi_pos_industry`.`sale_txn_invoices` (`location_id` ASC, `business_date` ASC, `register` ASC, `txn_no` ASC);

CREATE UNIQUE INDEX `uq_sale_txn_invoices_txn_master1_idx` ON `pi_pos_industry`.`sale_txn_invoices` (`location_id` ASC, `business_date` ASC, `register` ASC, `txn_no` ASC);
...
CREATE INDEX `fk_return_txn_voucher_txn_master1_idx` ON `pi_pos_industry`.`return_txn_vouchers` (`location_id` ASC, `business_date` ASC, `register` ASC, `txn_no` ASC);
...
CREATE INDEX `fk_expenses_txn_vouchers_txn_master1_idx` ON `pi_pos_industry`.`expense_txn_vouchers` (`location_id` ASC, `business_date` ASC, `register` ASC, `txn_no` ASC);
...
CREATE UNIQUE INDEX `uq_sale_txn_invoices_txn_master1_idx` ON `pi_pos_industry`.`sale_txn_invoices_audit` (`location_id` ASC, `business_date` ASC, `register` ASC, `txn_no` ASC);

USE `pi_pos_industry` ;

-- -----------------------------------------------------
-- Placeholder table for view `pi_pos_industry`.`v_item_location_tax`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`v_item_location_tax` (`item_id` INT, `name` INT, `long_desc` INT, `base_unit_cost` INT, `location_id` INT, `tax_group_id` INT, `tax_group_name` INT, `sgst_rate_rule_id` INT, `sgst_rate` INT, `sgst_amount` INT, `sgst_code` INT, `cgst_rate_rule_id` INT, `cgst_rate` INT, `cgst_amount` INT, `cgst_code` INT, `igst_rate_rule_id` INT, `igst_rate` INT, `igst_amount` INT, `igst_code` INT);

-- -----------------------------------------------------
-- Placeholder table for view `pi_pos_industry`.`v_location_tax`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`v_location_tax` (`location_id` INT, `billing_location` INT, `tax_group_id` INT, `tax_group_name` INT, `tax_group_desc` INT, `tax_group_rate_seq` INT, `tax_group_rate_name` INT, `tax_group_rate_desc` INT, `compound_flag` INT, `type_code` INT, `tax_rate_rule_id` INT, `seq_no` INT, `effective_Date` INT, `expiry_date` INT, `percentage` INT, `amount` INT);

-- -----------------------------------------------------
-- Placeholder table for view `pi_pos_industry`.`v_receipt_li_item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pi_pos_industry`.`v_receipt_li_item` (`name` INT, `long_desc` INT, `seq_no` INT, `upc_no` INT, `hsn_no` INT, `qty` INT, `unit_price` INT, `extended_amount` INT, `discount_amount` INT, `tax_amount` INT, `gross_amount` INT, `location_id` INT, `register` INT, `business_date` INT, `txn_no` INT, `item_id` INT, `SGST_tax_group_id` INT, `SGST_tax_rule_rate_id` INT, `SGST_percentage` INT, `SGST_amount` INT, `CGST_tax_group_id` INT, `CGST_tax_rule_rate_id` INT, `CGST_percentage` INT, `CGST_amount` INT, `IGST_tax_group_id` INT, `IGST_tax_rule_rate_id` INT, `IGST_percentage` INT, `IGST_amount` INT);
