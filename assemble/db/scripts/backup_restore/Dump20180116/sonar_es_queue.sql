...
--
-- Table structure for table `es_queue`
--
...
CREATE TABLE `es_queue` (
  ...
  PRIMARY KEY (`uuid`),
  KEY `es_queue_created_at` (`created_at`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `es_queue`
--

LOCK TABLES `es_queue` WRITE;
/*!40000 ALTER TABLE `es_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `es_queue` ENABLE KEYS */;
UNLOCK TABLES;
