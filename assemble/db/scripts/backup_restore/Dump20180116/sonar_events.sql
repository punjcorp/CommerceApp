...
CREATE TABLE `events` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `events_uuid` (`uuid`),
  KEY `events_analysis` (`analysis_uuid`),
  KEY `events_component_uuid` (`component_uuid`)
...
INSERT INTO `events` VALUES (2,'1.0-SNAPSHOT','Version',NULL,NULL,1515747189875,1515747767087,'AWDlrzjyQ399a3HcZKo9','AWDpmqD6IyCG1-aW1NXP','AWDpm3MvIyCG1-aW1NXQ');
...
-- Dump completed on 2018-01-16 18:57:20
