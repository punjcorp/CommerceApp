...
--
-- Dumping data for table `perm_templates_users`
--

LOCK TABLES `perm_templates_users` WRITE;
/*!40000 ALTER TABLE `perm_templates_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `perm_templates_users` ENABLE KEYS */;
UNLOCK TABLES;
