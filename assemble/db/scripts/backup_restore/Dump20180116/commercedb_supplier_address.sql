...
CREATE TABLE `supplier_address` (
  ...
  CONSTRAINT `fk_supplier_addresses_address_master1` FOREIGN KEY (`address_id`) REFERENCES `address_master` (`address_id`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
INSERT INTO `supplier_address` VALUES (10,5),(25,12),(34,26),(24,27),(35,27);
