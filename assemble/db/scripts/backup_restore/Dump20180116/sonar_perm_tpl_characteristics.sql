...
--
-- Table structure for table `perm_tpl_characteristics`
--
...
--
-- Dumping data for table `perm_tpl_characteristics`
--

LOCK TABLES `perm_tpl_characteristics` WRITE;
/*!40000 ALTER TABLE `perm_tpl_characteristics` DISABLE KEYS */;
/*!40000 ALTER TABLE `perm_tpl_characteristics` ENABLE KEYS */;
UNLOCK TABLES;
