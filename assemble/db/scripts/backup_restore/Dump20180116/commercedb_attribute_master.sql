...
CREATE TABLE `attribute_master` (
  ...
  UNIQUE KEY `attribute_master_index2` (`code`,`seq_no`)
...
INSERT INTO `attribute_master` VALUES (1,'L','S','Large Size','Size for an item',1),(2,'M','S','Medium Size','Medium Size',2),(3,'S','S','Small Size',NULL,3),(4,'Red','C','Red Color','Red Color',1),(5,'Green','C','Green',NULL,2),(6,'4.5','D','Length',NULL,1),(7,'6','D','Breadth',NULL,2),(8,'8','D','Height',NULL,3);
