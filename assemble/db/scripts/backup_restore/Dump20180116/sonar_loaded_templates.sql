...
CREATE TABLE `loaded_templates` (
  ...
  PRIMARY KEY (`id`),
  KEY `ix_loaded_templates_type` (`template_type`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `loaded_templates`
--

LOCK TABLES `loaded_templates` WRITE;
/*!40000 ALTER TABLE `loaded_templates` DISABLE KEYS */;
INSERT INTO `loaded_templates` VALUES (1,'SonarQube way','QUALITY_GATE'),(2,'DisplayLogOnDeprecatedProjects','ONE_SHOT_TASK');
/*!40000 ALTER TABLE `loaded_templates` ENABLE KEYS */;
UNLOCK TABLES;
