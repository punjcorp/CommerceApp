...
--
-- Dumping data for table `manual_measures`
--

LOCK TABLES `manual_measures` WRITE;
/*!40000 ALTER TABLE `manual_measures` DISABLE KEYS */;
/*!40000 ALTER TABLE `manual_measures` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-01-16 18:57:19
