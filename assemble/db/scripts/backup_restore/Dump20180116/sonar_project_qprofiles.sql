...
--
-- Table structure for table `project_qprofiles`
--
...
--
-- Dumping data for table `project_qprofiles`
--

LOCK TABLES `project_qprofiles` WRITE;
/*!40000 ALTER TABLE `project_qprofiles` DISABLE KEYS */;
/*!40000 ALTER TABLE `project_qprofiles` ENABLE KEYS */;
UNLOCK TABLES;
