...
CREATE TABLE `purchase_order_payment` (
  ...
  `paye_account` varchar(40) DEFAULT NULL,
  ...
  KEY `fk_purchase_order_payment_purchase_order1` (`order_id`),
  CONSTRAINT `fk_purchase_order_payment_purchase_order1` FOREIGN KEY (`order_id`) REFERENCES `purchase_order` (`order_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
