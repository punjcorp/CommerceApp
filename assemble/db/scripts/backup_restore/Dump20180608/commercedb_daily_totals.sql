...
CREATE TABLE `daily_totals` (
  ...
  `total_txn_amount` decimal(10,0) DEFAULT NULL,
  `total_sales_amount` decimal(10,0) DEFAULT NULL,
  `total_returns_amount` decimal(10,0) DEFAULT NULL,
...
INSERT INTO `daily_totals` VALUES (1,7997,NULL,'2018-05-24 00:00:00',27,NULL,NULL,-384,NULL,NULL),(2,7997,'1','2018-05-24 00:00:00',27,NULL,NULL,-384,NULL,NULL);
